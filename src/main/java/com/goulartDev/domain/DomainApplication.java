...
import com.goulartDev.domain.Repositories.ClientRepository;
import com.goulartDev.domain.Repositories.OrderItemRepository;
import com.goulartDev.domain.Repositories.OrderRepository;
import com.goulartDev.domain.Repositories.ProductRepository;
...
import com.goulartDev.domain.entities.OrderStatus;
...
public void run(String... args) throws Exception {
	...
	Order o1= new Order(null, Instant.parse("2023-04-18T11:25:09Z"), OrderStatus.PAID, c1) ;
	Order o2= new Order(null, Instant.parse("2023-04-18T11:25:09Z"), OrderStatus.WAITING, c1) ;
